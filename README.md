...
The camera calibration parameters are already provided with the code. The camera used was a mobile camera of a oneplus 6 with 12 MP and approx 25mm focal length. 
...
There are also different feature detection algorithms, SURF is used here but others can also be used.
...
An example dataset with 3 different objects are provided for testing. 
